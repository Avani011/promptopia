...
const PromptCards = ({post, handleTagClick, handleEdit, handleDelete}) => {
    ...
    <div className="prompt_card">
      ...
      items-start gap-5">
        ...
        items-center gap-3 cursor-pointer">
          ...
          <div className="flex flex-col">
            <h3 className="font-santoshi font=semibold
            text-gray-900">
      ...
      pathName === '/profile' && (
        ...
        border-t border-gray-100 pt-3">
          ...
          cursor-pointer" onClick={handleEdit}>
            Edit
          </p>
